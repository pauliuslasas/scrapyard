...
describe('Metal part update', () => {
  ...
  test('Rust should increase by 7, when winter is picked on metal part ', () => {
    // ARANGE
    // ACT
    update.updatePart(part, season);
    // ASSERT
    expect(part.rustiness).toEqual(7);
  });
  ...
  test('Quality should decrease by 4.9, when winter is picked on metal part ', () => {
    // ARANGE
    // ACT
    update.updatePart(part, season);
    // ASSERT
    expect(part.quality).toEqual(45.1);
  });
  ...
  test('Price should decrease by 7%, when part quality is > 40 ', () => {
    // ARANGE
    // ACT
    update.updatePart(part, season);
    // ASSERT
    expect(part.price).toEqual(93);
  });
